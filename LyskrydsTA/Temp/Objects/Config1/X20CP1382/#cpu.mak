...
export AS_CPU_PATH_2 := C:/Users/Kasper/Documents/Matematik RobTek/LyskrydsTA/Temp//Objects/$(AS_CONFIGURATION)/$(AS_PLC)
...
$(AS_BINARIES_PATH)/$(AS_CONFIGURATION)/$(AS_PLC)/Transfer.lst: \
	...
	@'$(AS_BIN_PATH)/BR.AS.FinalizeBuild.exe' '$(AS_PROJECT_PATH)/LyskrydsTA.apj' -t '$(AS_TEMP_PATH)' -o '$(AS_BINARIES_PATH)' -c '$(AS_CONFIGURATION)' -i 'C:/BrAutomation/AS43' -S 'X20CP1382'   -A 'X20CP1382' -pil   -swFiles '$(AS_PROJECT_PATH)/Physical/Config1/X20CP1382/Cpu.sw' -Z 'Acp10Arnc0: 3.16.2, mapp: 1.60.0, UnitSystem: n.d, TextSystem: n.d, Connectivity: n.d, AAS: n.d' -C '/RT=1000 /AM=*' -D '/IF=COM1 /BD=57600 /PA=2 /IT=20 /RS=0' -M IA32 -T SG4
